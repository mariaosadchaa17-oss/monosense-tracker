...
export function RivnaApp({ initialLoggedIn = false }: { initialLoggedIn?: boolean }) {
  ...
  return <main className="app-shell">
    ...
    <section className="content">
      ...
      {page === "Головна" && <Dashboard balance={balance} baseCurrency={baseCurrency} accounts={accounts} transactions={normalizedTransactions} goals={goals} authenticated={initialLoggedIn} openPage={setPage} addAccount={() => setModal("account")}/>}
