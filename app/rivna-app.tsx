...
.empty-state-icon{width:44px;height:44px;border-radius:50%;background:color-mix(in srgb,var(--purple) 10%,var(--panel));color:var(--purple);display:grid;place-items:center}
.empty-state-icon svg{width:20px}
